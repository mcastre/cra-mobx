...
function createStore(reducer, initialState, enhancer) {
  ...
  function addReducerSelector(reducerName) {
    if (selectors[reducerName] === undefined) {
      selectors[reducerName] = function (state) {
  ...
  function addSelector(newSelectorName, selectorNamesArray, selectorFunction) {
    ...
    selectors[newSelectorName] = (0, _reselect.createSelector)(useSelectors(selectorNamesArray), selectorFunction);
  ...
  function addReducers(newReducers) {
    ...
    reducerObject = (0, _assign2['default'])((0, _assign2['default'])({}, newReducers), reducerObject);

    currentReducer = (0, _combineReducers2['default'])(reducerObject);
    currentState = (0, _assign2['default'])((0, _assign2['default'])({}, initialStateForNewReducers), currentState);

    if (pendingDispatches.length) {
      pendingDispatches.forEach(function (action) {
        dispatch(action);
      });
  ...
  return _ref2 = {
    ...
    dispatch: dispatch,
    getSelectorByName: getSelectorByName,
    subscribe: subscribe,
    getState: getState,
